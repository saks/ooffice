...
change chart name. Assign new name to chart like <code>table::sex_and_age_chart</code>.
Name must contain mandatory key word (<code>table</code>) and some another name by you
(to access it via substitution api) joined with <code>::</code>.
